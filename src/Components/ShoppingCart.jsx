                                ...
                                <div className='Buttonscar'>
                                    <div className='IconsCar' style={{display:"flex"}}>
                                        <div className='icon' style={{padding:"0px 20px"}} >
                                            <i onClick={() => { del(e.id) }} className="fa-solid fa-trash-can" ></i>
                                        </div>
                                        <div className='icon' style={{padding:"0px 20px"}}>
                                            <i onClick={() => { add({ id: e.id, newQuantity: parseInt(e.productsInCart.quantity) + 1 }) }} className="fa-solid fa-plus"> </i>

                                        </div>
                                        <div className='icon' style={{padding:"0px 20px"}}>
                                            <i onClick={() => { substract({ id: e.id, newQuantity: parseInt(e.productsInCart.quantity) - 1 }) }} className="fa-solid fa-minus"></i>
